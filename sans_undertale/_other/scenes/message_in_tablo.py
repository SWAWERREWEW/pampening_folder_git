...
def message_in_tablo(message, cont, message2=None, message3=None, color=None, color2=None, color3=None, enemy_have=None):
    ...
    _other.cons.scr.blit(_other.cons.my_font.render(message, False, color), (_other.obj.field_b.x, _other.obj.field_b.y))
    if message2:
        _other.cons.scr.blit(_other.cons.my_font.render(message2, False, color2), (_other.obj.field_b.x, _other.obj.field_b.y + 30))
    if message3:
        _other.cons.scr.blit(_other.cons.my_font.render(message3, False, color3), (_other.obj.field_b.x, _other.obj.field_b.y + 60))
