...
bones = [_other.obj.Plr_img(_other.obj.field_b.x, _other.obj.field_b.y, 50, 150, "_other/imgs/bone_vertical.png", 2,
...
bones[1].wid, bones[1].hei = 150, 50

bones[1].x, bones[1].y = _other.obj.field_b.x + _other.obj.field_b.wid - bones[1].wid, _other.obj.field_b.hei + _other.obj.field_b.y - bones[1].hei

bones[1].image = pygame.image.load("_other/imgs/bone_horisontal.png").convert_alpha()
