...
while _other.cons.run:
    ...
    if _other.cons.scene == _other.cons.scenes["menu"]:
        ...
        if _other.obj.sans.parem["hp"] <= 10:
            ...
            _other.scenes.message_in_tablo.message_in_tablo(" You eat" +
                                                            s.fight_act_items_mercy.buttons_lines_items[_other.cons.focus][0],
    "enemy_ataks", " you restore " +
                                                            str(s.fight_act_items_mercy.buttons_lines_items[_other.cons.focus][1]),
" Your HP is full")
        else:
            _other.scenes.message_in_tablo.message_in_tablo(" You eat " +
                                                            s.fight_act_items_mercy.buttons_lines_items[_other.cons.focus][0], "enemy_ataks",
            " you restore " +
                                                            str(s.fight_act_items_mercy.buttons_lines_items[_other.cons.focus][1]))
